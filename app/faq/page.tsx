...
const faqs = [
  // 基本情報・営業について
  {
    ...
    items: [
      ...
      {
        q: 'テイクアウト専門のお店ですか？イートインはできますか？',
        a: 'カルカモはテイクアウト専門のスタンド形式のお店です。イートインスペースはありません。購入後は近くのベンチや公園などでお楽しみいただけます。',
      },
      {
        q: '電話番号はありますか？',
      ...
      },
      {
        ...
        a: '申し訳ありませんが、現時点では現金のみのお支払いとなっています。最新の支払い方法については、来店前にInstagramでご確認ください。',
      },
      {
