          ...
          <AnimateIn delay={0.1}>
            <ul className="max-w-2xl">
              {[
                ...
                {
                  title: '人気No.1 明太もちチーズ',
                  body: '4種類の中でも特に人気が高いのが「明太もちチーズお好み焼き」です。とろとろに溶けたチーズ、もちもちした食感のお餅、ピリ辛の明太子の組み合わせが絶妙。一度食べるとリピートする方が続出するほどの人気メニューで、初めてご来店の方にもぜひお試しいただきたい一品です。',
                },
              ].map((item, i) => (
